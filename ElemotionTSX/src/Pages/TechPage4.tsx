      ...
      <div className={`${layout.section}`}>
        <div className={`${layout.sectionInfo}  relative md:ml-10 ml-0  `}>
          ...
          <p className={styles.paragraph}>
            ...
            device—from smartphones to cars to the burgeoning IoT. Qualcomm
            Wi-Fi 6 solutions are helping support a technology transition that
            will impact nearly every kind of connected device—from smartphones
            to cars to the burgeoning IoT.
          </p>
