...
import { channel32 } from "../resources";
import { Link } from "react-router-dom";
import { aspects2 } from "../Constants";
...
md:flex-row flex-col - children are horizontally arranged in a row
 ${styles.paddingY} - padding along the y-axis*/}
       ...
       has some padding*/}
          <div className={`${layout.sectionInfo} py-5  ${styles.paddingX}`}>
            ...
            <p className=" font-semibold text-dimWhite text-[40px] leading-[40.8px]">
              High-Density surface EMG (HD-sEMG) detection system for clinical
              applications{" "}
            </p>

            {/* Paragraph */}
            <p className={`${styles.paragraph} mt-10`}>
              This 32-channel surface EMG detection system consist of
              independent high-accurate EMG amplifiers, a wireless sensing
              device, and a software for real-time visualization and
              professional clinical data analysis. This detection system is
              portable for various clinical applications and have been involved
              in several clinical research for functional prosthesis training
              and teenagers’ scoliosis study.{" "}
            </p>
            ...
            >
              ...
              <li>Rehabilitation centers for amputees </li>
              <li> Clinical neuromuscular research teams </li>
              <li> Healthcare Institutions</li>
              <li> Functional prosthesis companies </li>
            </p>
          </div>
        ...
        Houses our image. Its a flex container with dynamic shrinking and growing. Aligned to the center of both axes. Has some padding and margin */}
          <div
            className={`flex-1 flex ${styles.flexCenter} pr-10 md:mt-0 mt-10 `}
          >
      ...
      multiple lines if all cannot fit on one line. Ensures even spacing between the children. Spans the full width. Has some padding and margin */}
          <div className="flex flex-1 md:flex-row flex-col flex-wrap justify-between w-full  mt-8 sm:px-16 px-6">
...
export default MuscleMatrix_32X;
