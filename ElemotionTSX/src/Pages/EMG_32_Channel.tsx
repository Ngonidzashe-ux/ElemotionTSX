...
const AspectCard = ({
  ...
  return (
    ...
    <div className="flex justify-center flex-col items-center bg-gray-900 w-[30%] mb-10 ">
       ...
       has some padding*/}
          <div className={`${layout.sectionInfo} py-5  ${styles.paddingX}`}>
            ...
            <p className={`${styles.paragraph} mt-10`}>
              The portable EMG sensor comprises of micro-structured electrodes,
              a highly integrated sensing system, and an app for visualization
              and personalized guidance. The sensor is small and lightweight
              without compromising detection accuracy, making it highly
