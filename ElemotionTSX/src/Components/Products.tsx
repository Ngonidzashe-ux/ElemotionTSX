...
const ProductCard = ({
  ...
  <div className="flex  justify-center items-center flex-col rounded-[10px] md:h-[720px] md:w-[43%] w-full  md:mr-20 mr-6 my-1 md:mb-0 mb-10 bg-gray-800">
    ...
    of ease. */}
    <div className="px-2 pt-2 h-[320px] w-full  ">
      <img
        src={img}
        loading="lazy"
        alt={title}
    ...
    <div className="flex justify-center items-center px-12 mt-8">
      ...
      <div className="text-center">
        ...
        <h4 className="font-poppins md:h-[30px] font-semibold text-[32px] leading-[40px] text-white mb-8">
          {title}
        </h4>

        {/* Text with below classes  */}
        <p className="font-poppins md:h-[160px]  font-normal md:text-[25px] text-[20px] md:leading-[32px] leading-[32px] text-dimWhite">
          {content}
        </p>
      </div>
    </div>
...
const Products = () => (
  ...
  <section
    id="clients"
    className={`${styles.paddingY} ${styles.flexCenter} flex-col my-10  `}
  >
    ...
    container class.*/}
    <div className="flex flex-wrap md:justify-between justify-start items-start w-full md:max-h-[720px]  rounded-[5px] ">
