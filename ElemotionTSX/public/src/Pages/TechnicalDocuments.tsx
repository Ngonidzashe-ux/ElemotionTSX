...
import { document, wolf } from "../resources";
...
{/* padding */}
      <div className={`${styles.paddingX} ${styles.paddingY}`}>
        ...
        <div className="flex justify-start items-center flex-row">
          ...
          <img src={document} alt="double_quotes" className="w-[100px] h-[100px] object-contain" />\

          {/* Heading */}
          <h4 className="font-poppins font-semibold text-[60px] leading-[52px] text-white ml-4"> Technical <span className="text-secondary">Documents</span></h4>
        </div>
...
{/* Flex container with dynamic growth and row as direction from md and above sizes, otherwise col on sm devices and smaller */}
...
at the top which is the starting. Specific width */}
          <div className={`flex justify-start md:items-center items-start w-[580px]`}>

            {/* heading */}
            <h4 className="font-poppins font-semibold text-[45px] leading-[42px] text-white"> EMG Sensors </h4>
          </div>
          ...
          <div className='flex flex-col md:justify-center justify-start items-center'>
            ...
            "noopener": When a link is opened in a new tab or window using the target="_blank" attribute, the new tab/window can potentially access and modify the contents
             of the tab/window that opened it. This is called the window.opener property. If the linked page is malicious, it could use this property to perform unwanted
               ...
               */}
            <a href={wolf} target="_blank" rel="noopener noreferrer" className={`font-poppins font-normal text-secondary text-[25px] leading-[40.8px] my-3`}>
